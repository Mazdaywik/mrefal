...
refalrts::FnResult CoreP_MFileIOP_ReadLine(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  refalrts::this_is_generated_function();
  do {
    refalrts::Iter bb_0 = arg_begin;
    refalrts::Iter be_0 = arg_end;
...
refalrts::FnResult CoreP_MFileIOP_InitE_(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    const static refalrts::ResultAction raa[] = {
      ...
      {refalrts::icFunc, (void*) & CoreP_MFileIOP_InitializeE_, (void*) "CoreP_MFileIOP_InitializeE_"},
      {refalrts::icFunc, (void*) & CoreP_MFileIOP_FinalizeE_, (void*) "CoreP_MFileIOP_FinalizeE_"},
      {refalrts::icBracket, 0, 0, refalrts::ibCloseCall},
      {refalrts::icEnd}
    };
    refalrts::Iter allocs[2*sizeof(raa)/sizeof(raa[0])];
