...
refalrts::FnResult RegisterE_(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::move_left( bb_0, be_0 );
    refalrts::move_right( bb_0, be_0 );
    refalrts::Iter sFnInit_1;
    refalrts::Iter sFnFinal_1;
    // s.FnInit s.FnFinal
...
static refalrts::FnResult SwRegistered(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::move_right( bb_0, be_0 );
    refalrts::Iter sFnFinal_1;
    refalrts::Iter eFinalizers_B_b_1;
    refalrts::Iter eFinalizers_B_e_1;
    refalrts::Iter eFinalizers_E_b_1;
    refalrts::Iter eFinalizers_E_e_1;
    refalrts::Iter sFnInit_1;
    refalrts::Iter sFnFinal_2;
  ...
  do {
    ...
    refalrts::Iter sFnInit_1;
    refalrts::Iter sFnFinal_1;
    refalrts::Iter eFinalizers_b_1;
    refalrts::Iter eFinalizers_e_1;
...
static refalrts::FnResult SwOpen(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::move_right( bb_0, be_0 );
    refalrts::Iter sMode_1;
    refalrts::Iter sNumHandle_1;
    refalrts::Iter eFileName_b_1;
    refalrts::Iter eFileName_e_1;
    refalrts::Iter eHandles_B_b_1;
    refalrts::Iter eHandles_B_e_1;
    refalrts::Iter eHandles_E_b_1;
    refalrts::Iter eHandles_E_e_1;
    refalrts::Iter sNumHandle_2;
...
static refalrts::FnResult HandleFromNum_Aux(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::move_right( bb_0, be_0 );
    refalrts::Iter sNum_1;
    refalrts::Iter eHandles_b_1;
    refalrts::Iter eHandles_e_1;
    // s.Num e.Handles
    if( ! refalrts::svar_left( sNum_1, bb_0, be_0 ) ) 
      break;
    eHandles_b_1 = bb_0;
...
static refalrts::FnResult Nil(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::move_left( bb_0, be_0 );
    refalrts::move_right( bb_0, be_0 );
    refalrts::Iter eAny_b_1;
    refalrts::Iter eAny_e_1;
    // e.Any
    eAny_b_1 = bb_0;
...
refalrts::FnResult MRefalRTSP_Put(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::Iter eText_b_1;
    refalrts::Iter eText_e_1;
    refalrts::Iter eText_b_2;
    refalrts::Iter eText_e_2;
    // s.Num e.Text
    if( ! refalrts::svar_left( sNum_1, bb_0, be_0 ) ) 
      break;
    eText_b_1 = bb_0;
...
refalrts::FnResult MRefalRTSP_Numb(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::move_left( bb_0, be_0 );
    refalrts::move_right( bb_0, be_0 );
    refalrts::Iter eString_b_1;
    refalrts::Iter eString_e_1;
    // e.String
    eString_b_1 = bb_0;
...
static refalrts::FnResult Convert(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::move_left( bb_0, be_0 );
    refalrts::move_right( bb_0, be_0 );
    refalrts::Iter sFnConv_1;
    refalrts::Iter sType_1;
    refalrts::Iter eInBracket_b_1;
    refalrts::Iter eInBracket_e_1;
    refalrts::Iter eString_b_1;
    refalrts::Iter eString_e_1;
    refalrts::Iter sFnConv_2;
    refalrts::Iter sType_2;
    refalrts::Iter eInBracket_b_2;
    refalrts::Iter eInBracket_e_2;
...
static refalrts::FnResult Convert_Symb(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::Iter sSymbol_1;
    refalrts::Iter sFnConv_1;
    refalrts::Iter sType1_1;
    refalrts::Iter sType2_1;
