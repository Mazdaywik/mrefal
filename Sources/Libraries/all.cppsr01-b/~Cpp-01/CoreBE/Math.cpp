...
REFAL_FUNC(CoreBEP_MathP_InitE_, "CoreBE.Math.Init#ENTRY") {
...
REFAL_FUNC(CoreBEP_MathP_NumberCompare, "CoreBE.Math.NumberCompare") {
  return implement_math::compare(arg_begin, arg_end);
}

REFAL_FUNC(CoreBEP_MathP_Binary, "CoreBE.Math.Binary") {
