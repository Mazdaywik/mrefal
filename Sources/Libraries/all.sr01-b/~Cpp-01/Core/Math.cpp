...
refalrts::FnResult CoreP_MathP_InitE_(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
...
refalrts::FnResult CoreP_MathP_NumberCompare(
  refalrts::Iter arg_begin, refalrts::Iter arg_end
) {
  return implement_math::compare(arg_begin, arg_end);
}

refalrts::FnResult CoreP_MathP_Binary(
  refalrts::Iter arg_begin, refalrts::Iter arg_end
) {
